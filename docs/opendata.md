# Концепція open data
Відкриті дані — це концепція, за якою певні дані мають бути вільними для використання та розповсюдження будь-якою особою, за умов дотримання правил атрибуції та/або share-alikeліцензії.
...
* [Офіційне інтернет-представництво НБУ](https://www.bank.gov.ua/control/uk/index)
...
## Впорядковані та невпорядковані данні
